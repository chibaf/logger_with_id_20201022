...
void loop()
{
  ...
  if (ticked) {
    ...
    //温度取得　2チャンネルあるI2Cバスを交互に使って負荷を落とす  // commented out // not on 20201022
...
//    temp1=random(20,25);  // random temp 20~25 // commented out 20200001022
//    temp2=random(20,25);
//    temp3=random(20,25);
//    temp4=random(20,25);
//    temp5=random(20,25);
...
//    temp10=random(20,25);
    ...
    img.deleteSprite();
    int logger_id=3;  //20201022 added
    //シリアル出力
